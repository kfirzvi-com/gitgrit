...
urlpatterns = [
    ...
    path(
        "tenants/support/leave/",
        leave_support_view_view,
        name="leave_support_view",
    ),
    ...
    path(
        "tenants/github-app/choose/",
        github_app_choose,
        name="github_app_choose",
    ),
    path(
        "tenants/github-app/install-new/",
        github_app_install_new,
        name="github_app_install_new",
    ),
    # LLM providers & roles
